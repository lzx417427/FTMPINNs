...
# example5_net=np.load('./np_weight/shenjingyuan0.5_128.npy').tolist()

example4_net=np.load('./np_weight/shenjingyuan0.5_64.npy').tolist()
# example5_net=np.load('./np_weight/shenjingyuan0.5_128.npy').tolist()
example5_net=np.load('./np_weight/shenjingyuan0.5_128.npy').tolist()
...
plt.plot(log_losses1, label=r'$\alpha=0.2$: Net Structure1', color='orange',  linewidth=1.5,  linestyle='-')
# plt.plot(log_losses4, label='FTM-PINNs α=0.5', color='y',   linewidth=2,linestyle='--')
plt.plot(log_losses2, label=r'$\alpha=0.2$: Net Structure2', color='b',   linewidth=1.5,linestyle='-')
plt.plot(log_losses3, label=r'$\alpha=0.2$: Net Structure3', color='green',   linewidth=1.5,linestyle='-')

plt.plot(log_losses4, label=r'$\alpha=0.5$: Net Structure1', color='r',   linewidth=1.5,linestyle='-')
plt.plot(log_losses5, label=r'$\alpha=0.5$: Net Structure2', color='purple',   linewidth=1.5,linestyle='-')
plt.plot(log_losses6, label=r'$\alpha=0.5$: Net Structure3', color='gray',   linewidth=1.5,linestyle='-')
